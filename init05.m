...
% the course TTK4135. Only use this file for the helicopter 5. On It's
...
%%%%%%%%%%% Physical constants
%%wights
m_w = 1.800;                        % Mass of the counterweight
m_h = 1.311;                        % Mass of helicopter
m_g = 0.010;                        % Effective mass of the helicopter
%%Distances
l_a = .64;                          % Distance from elevation axis to helicopter body
...
V_b_eq=.707;                          % 0.85;%1.2; Voltage motor in back, Change the value so that it matches the current helicopter
