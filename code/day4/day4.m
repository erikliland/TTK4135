...
save (sprintf('../../measurements/measurements_q_%d_%d_%d_%d_%d_%d.mat', Q_LQR(1,1), Q_LQR(2,2), Q_LQR(3,3), Q_LQR(4,4), Q_LQR(5,5), Q_LQR(6,6)), 'simout_measurements');
t = measurements(1,:);
...
subplot(2,1,2);
hold all;
plot(t,elevation, 'LineWidth', 2,'LineStyle','--');
legend('Elevation', 'Elevation setpoint', 'Constraint','Real elevation');
