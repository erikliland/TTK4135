...
m_1_1_1_1 = load('../../measurements/day3/measurements_q_1_1_1_1.mat');
m_1_1_10_1= load('../../measurements/day3/measurements_q_1_1_10_1.mat');
m_50_1_10_1=load('../../measurements/day3/measurements_q_50_1_1_1.mat');
...
plot(m_1_1_1_1.measurements(1,:),180/pi*m_1_1_1_1.measurements(2,:)    ,'LineWidth',2,'LineStyle','-');
plot(m_1_1_10_1.measurements(1,:),180/pi*m_1_1_10_1.measurements(2,:)  ,'LineWidth',2,'LineStyle','-');
plot(m_50_1_10_1.measurements(1,:),180/pi*m_50_1_10_1.measurements(2,:),'LineWidth',2,'LineStyle','-');
legend('Opt travel ref', 'diag(1 1 1 1)','diag(1 1 10 1)', 'diag(50 1 10 1)','Location','North');
