...
void helikopter_output(int_T tid)
{
   ...
   */
  rtb_Sum = helikopter_P.elevation_Value - helikopter_B.Gain[4];
  ...
  if (rtmIsMajorTimeStep(helikopter_M)) {
     ...
     *  Constant: '<Root>/pitch'
     */
    helikopter_B.Saturation = rt_SATURATE(helikopter_P.pitch_Value,
      helikopter_P.Saturation_LowerSat_m, helikopter_P.Saturation_UpperSat_c);
  }
   ...
   *  Sum: '<S3>/Sum1'
   */
  rtb_Sum = (helikopter_B.Saturation - helikopter_B.Gain[2]) *
...
void helikopter_initialize(boolean_T firstTime)
{
  ...
  /* external mode info */
  helikopter_M->Sizes.checksums[0] = (2096606402U);
  helikopter_M->Sizes.checksums[1] = (4289862234U);
  helikopter_M->Sizes.checksums[2] = (3520454365U);
  helikopter_M->Sizes.checksums[3] = (807969407U);
...
void MdlInitializeSizes(void)
{
  ...
  helikopter_M->Sizes.numBlockIO = (10);/* Number of block outputs */
  helikopter_M->Sizes.numBlockPrms = (147);/* Sum of parameter "widths" */
}
